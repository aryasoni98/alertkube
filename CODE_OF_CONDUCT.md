...
alertkube has adopted the **CNCF Community Code of Conduct** verbatim (reproduced
below). It applies to every community space connected to the project: the GitHub
repository (issues, pull requests, discussions), chat channels, and any event or
forum where someone is participating as a member of the alertkube community.

**Reporting a project-level incident:** for conduct issues involving alertkube
specifically, you may contact the maintainer privately through a
[GitHub Security Advisory](https://github.com/aryasoni98/alertkube/security/advisories/new)
(use it as a private channel) or by direct message to the maintainers listed in
[`MAINTAINERS.md`](MAINTAINERS.md). For incidents that are project-agnostic, span
multiple CNCF projects, or where you would prefer an independent body, use the
CNCF Code of Conduct Committee contact below. You can expect a response within
three business days.
